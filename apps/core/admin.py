...
class TopicAdmin(admin.ModelAdmin):
    """主题管理"""
    list_display = ['title', 'board', 'author', 'views_count', 'reply_count', 'is_pinned', 'is_locked', 'review_status', 'created_at']
...
# ========== 内容审核 ==========
from moderation.models import SensitiveWord, ModerationLog, ModerationAdmin, ModerationReminder, UserReputation, ReputationLog
