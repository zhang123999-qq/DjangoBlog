    ...
    responses={
        ...
        400: OpenApiResponse(
            ...
            examples=[
                ...
                OpenApiExample(
                    "Image type not allowed", value=api_error_payload(ErrorCodes.UPLOAD_IMAGE_TYPE_NOT_ALLOWED)
                ),
...
def upload_file(request):
    ...
    if UPLOAD_ASYNC_PIPELINE_ENABLED:
        ...
        try:
            ...
            return Response(
                api_error_payload(ErrorCodes.UPLOAD_SAVE_FAILED), status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
