    ...
    class Meta:
        ...
        widgets = {
            "title": forms.TextInput(
                attrs={"class": "form-control form-control-lg", "placeholder": "请输入文章标题", "data-editor": "none"}
            ),
            "summary": forms.Textarea(
                attrs={"class": "form-control", "rows": 3, "placeholder": "请输入文章摘要（可选，用于SEO和列表显示）"}
            ),
            "content": forms.Textarea(
                attrs={"class": "form-control", "rows": 20, "data-editor": "tinymce", "data-height": "500"}
            ),
