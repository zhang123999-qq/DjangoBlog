...
def register_view(request):
    ...
    try:
        ...
        return render(request, 'accounts/register.html', {'form': UserRegisterForm(request=request), 'captcha_image': generate_captcha()[1]})
...
def login_view(request):
    ...
    try:
        ...
        captcha_code, captcha_image = generate_captcha()
        store_captcha(request, captcha_code)
        return render(request, 'accounts/login.html', {'form': CustomLoginForm(request=request), 'captcha_image': captcha_image})
