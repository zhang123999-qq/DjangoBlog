...
class TestNotificationModel:
    ...
    def test_create_notification(self, user):
        ...
        notification = Notification.objects.create(
            user=user, title="测试通知", content="这是测试通知内容", notification_type="system"
        )
    ...
    def test_mark_as_read(self, user):
        """测试标记已读"""
        notification = Notification.objects.create(user=user, title="测试通知", content="内容")
...
class TestNotificationAPI:
    ...
    def test_mark_read(self, client, user):
        ...
        notification = Notification.objects.create(user=user, title="通知", content="内容")
