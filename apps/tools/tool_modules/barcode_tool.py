...
class BarcodeForm(forms.Form):
    ...
    height = forms.IntegerField(
        label="高度", min_value=20, max_value=200, initial=50, widget=forms.NumberInput(attrs={"class": "form-control"})
    )
...
class BarcodeTool(BaseTool):
    ...
    def handle(self, request, form):
        ...
        try:
            ...
            return {"text": text, "barcode_type": barcode_type, "image_base64": image_base64}
