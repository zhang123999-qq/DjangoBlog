...
from .serializers import (
    CategorySerializer, TagSerializer, PostSerializer, PostListSerializer,
    CommentSerializer, BoardSerializer, TopicSerializer, TopicListSerializer,
    ReplySerializer
)
...
class PostViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def comments(self, request, pk=None):
        ...
        comments = Comment.objects.filter(post=post, review_status='approved')
...
class BoardViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def topics(self, request, pk=None):
        ...
        topics = Topic.objects.filter(board=board, review_status='approved')
...
class TopicViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def replies(self, request, pk=None):
        ...
        replies = Reply.objects.filter(topic=topic, review_status='approved', is_deleted=False)
