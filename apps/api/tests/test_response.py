...
from apps.api.exception_handler import BusinessError, PermissionDeniedError, ResourceNotFound, exception_handler
...
class TestAPIResponse:
    ...
    def test_error_response_with_errors(self):
        ...
        response = APIResponse.error(message="验证失败", code=400, errors=errors)
    ...
    def test_paginated_response(self):
        """测试分页响应"""
        data = [{"id": 1}, {"id": 2}]
        response = APIResponse.paginated(data=data, page=1, page_size=20, total=100)
