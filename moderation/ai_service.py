...
class BaiduModerationService:
    ...
    def client(self):
        ...
        if self._client is None and self.enabled:
            try:
                ...
                logger.error(f'初始化百度 AI 客户端失败: {e}')
                self.enabled = False
    ...
    def moderate_text(self, content: str) -> Tuple[str, Optional[List[Dict]]]:
        ...
        try:
            ...
            logger.error(f'AI 文本审核失败: {e}')
            return 'error', [{'type': 'error', 'msg': str(e)}]
    ...
    def moderate_image_url(self, image_url: str) -> Tuple[str, Optional[List[Dict]]]:
        ...
        try:
            ...
            logger.error(f'AI 图片 URL 审核失败: {e}')
            return 'error', [{'type': 'error', 'msg': str(e)}]
